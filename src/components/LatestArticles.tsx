...
export default function LatestArticles({ posts }: { posts: GhostPost[] }) {
  ...
  return (
    <section id="articles" className="pt-10 pb-9 md:pt-14 md:pb-12 bg-white">
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-x-8 gap-y-14">
          {grid.map((post) => (
            ...
            >
              ...
              <h3 className="mt-4 font-paperlogy font-medium text-base md:text-lg leading-snug text-black line-clamp-2 text-left max-w-[70%] break-keep transition-colors group-hover:text-[#3F1C03]">
                {post.title}
              </h3>
            </Link>
          ))}
